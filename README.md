...
To optimize the RegPlat application for production, run:
...
[Service Discovery and Configuration with the JHipster-Registry]: https://jhipster.github.io/documentation-archive/v4.5.2/microservices-architecture/#jhipster-registry
