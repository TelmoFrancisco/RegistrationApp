...
import com.mycompany.regplat.service.SocialService;
...
public class SocialController {
    ...
    @GetMapping("/signup")
    public RedirectView signUp(WebRequest webRequest, @CookieValue(name = "NG_TRANSLATE_LANG_KEY", required = false, defaultValue = "\"pt-pt\"") String langKey) {
        try {
